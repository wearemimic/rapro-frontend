      ...
      <div class="col-sm-6 col-xl-6 mb-3 mb-xl-6">
        <div class="card mb-3 mb-lg-5">
          <div class="card-body">
            ...
            <p>This infomration looks at the Social Security Net Benefit at different ages, adjusted for Medicare costs. 
              The breakeven age is the age at 
              which the Social Security Net Benefit cumulative amount is equal at all ages.</p>
            <div style="height: 300px">
              <Graph 
    ...
    <div class="card mb-3 mb-lg-5">
      ...
      <div class="card-body">
        ...
        <ul class="nav nav-tabs" id="ssToolsTabs" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="income-layering-tab" data-bs-toggle="tab" data-bs-target="#income-layering" type="button" role="tab">
              Income Layering
            </button>
          </li>
          <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="ssToolsTabContent">
          ...
          <div class="tab-pane fade" id="income-layering" role="tabpanel">
            <div class="row mt-4">
              <div class="col-md-12 mb-4">
                <div class="card">
                  <div class="card-body">
                    <h6 class="card-subtitle mb-3">Income Layering Strategy Sandbox</h6>
                    <p class="small text-muted mb-3">Experiment with different income sources to optimize Social Security taxation and Medicare premiums.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-5">
                <div class="card">
                  <div class="card-body">
                    <h6 class="mb-3">Income Sources</h6>
                    
                    <div class="mb-3">
                      <label for="layeringFilingStatus" class="form-label">Filing Status</label>
                      <select class="form-select" id="layeringFilingStatus" v-model="incomeSandbox.filingStatus">
                        <option value="single">Single</option>
                        <option value="joint">Married Filing Jointly</option>
                        <option value="separate">Married Filing Separately</option>
                      </select>
                    ...
                    <div class="card mb-3">
                      <div class="card-header bg-light py-2">
                        <div class="d-flex justify-content-between align-items-center">
                          <span><i class="bi bi-currency-dollar me-1"></i> Social Security</span>
                      ...
                      <div class="card-body py-2">
                        <div class="input-group">
                          <span class="input-group-text">$</span>
                          <input type="number" class="form-control" v-model="incomeSandbox.sources.socialSecurity">
                          <span class="input-group-text">/year</span>
                        </div>
                      </div>
                    </div>
                    
                    <div class="card mb-3" :class="{ 'border-success': incomeSandbox.sources.traditionalIRA > 0 }">
                      <div class="card-header bg-light py-2">
                        <div class="d-flex justify-content-between align-items-center">
                          <span><i class="bi bi-piggy-bank me-1"></i> Traditional IRA</span>
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" v-model="incomeSandbox.enabled.traditionalIRA">
                          </div>
                        </div>
                      </div>
                      <div class="card-body py-2" v-if="incomeSandbox.enabled.traditionalIRA">
                        <div class="input-group">
                          <span class="input-group-text">$</span>
                          <input type="number" class="form-control" v-model="incomeSandbox.sources.traditionalIRA">
                          <span class="input-group-text">/year</span>
                        </div>
                      </div>
                    </div>
                    
                    <div class="card mb-3" :class="{ 'border-success': incomeSandbox.sources.rothIRA > 0 }">
                      <div class="card-header bg-light py-2">
                        <div class="d-flex justify-content-between align-items-center">
                          <span><i class="bi bi-piggy-bank me-1"></i> Roth IRA</span>
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" v-model="incomeSandbox.enabled.rothIRA">
                          </div>
                        </div>
                      </div>
                      <div class="card-body py-2" v-if="incomeSandbox.enabled.rothIRA">
                        <div class="input-group">
                          <span class="input-group-text">$</span>
                          <input type="number" class="form-control" v-model="incomeSandbox.sources.rothIRA">
                          <span class="input-group-text">/year</span>
                        </div>
                      </div>
                    </div>
                    
                    <div class="card mb-3" :class="{ 'border-success': incomeSandbox.sources.pension > 0 }">
                      <div class="card-header bg-light py-2">
                        <div class="d-flex justify-content-between align-items-center">
                          <span><i class="bi bi-briefcase me-1"></i> Pension</span>
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" v-model="incomeSandbox.enabled.pension">
                          </div>
                        </div>
                      </div>
                      <div class="card-body py-2" v-if="incomeSandbox.enabled.pension">
                        <div class="input-group">
                          <span class="input-group-text">$</span>
                          <input type="number" class="form-control" v-model="incomeSandbox.sources.pension">
                          <span class="input-group-text">/year</span>
                        </div>
                      </div>
                    </div>
                    
                    <div class="card mb-3" :class="{ 'border-success': incomeSandbox.sources.taxExemptInterest > 0 }">
                      <div class="card-header bg-light py-2">
                        <div class="d-flex justify-content-between align-items-center">
                          <span><i class="bi bi-cash-coin me-1"></i> Tax-Exempt Interest</span>
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" v-model="incomeSandbox.enabled.taxExemptInterest">
                          </div>
                        </div>
                      </div>
                      <div class="card-body py-2" v-if="incomeSandbox.enabled.taxExemptInterest">
                        <div class="input-group">
                          <span class="input-group-text">$</span>
                          <input type="number" class="form-control" v-model="incomeSandbox.sources.taxExemptInterest">
                          <span class="input-group-text">/year</span>
                        </div>
                      </div>
                    </div>
                    
                    <button class="btn btn-primary w-100" @click="calculateIncomeSandbox">Calculate Impact</button>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-7">
                <div class="card h-100">
                  <div class="card-body">
                    <h6 class="mb-3">Income Strategy Analysis</h6>
                    
                    <div v-if="incomeSandbox.calculated">
                      <!-- Income Analysis Chart -->
                      <div style="height: 250px">
                        <Graph 
                          :data="incomeSandboxChartData" 
                          :options="incomeSandboxChartOptions"
                          :height="250"
                        />
                      </div>
                        ...
                        <div class="col-md-6">
                          <div class="card bg-light">
                            <div class="card-body py-3">
                              <h6 class="card-title">Provisional Income</h6>
                              <h3 class="mb-0">${{ incomeSandbox.provisionalIncome.toLocaleString() }}</h3>
                              <p class="text-muted small mb-0">AGI + Tax-Exempt Interest + 50% of SS</p>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="card" :class="incomeSandbox.ssClass">
                            <div class="card-body py-3">
                              <h6 class="card-title">Social Security Taxable</h6>
                              <h3 class="mb-0">{{ incomeSandbox.taxableSSPercentage }}%</h3>
                              <p class="text-muted small mb-0">${{ incomeSandbox.taxableSSAmount.toLocaleString() }} of annual benefit</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="mt-4">
                        <div class="alert alert-info">
                          <h6 class="alert-heading">Strategy Insights</h6>
                          <p class="mb-0">{{ incomeSandbox.strategyInsight }}</p>
                        </div>
                      </div>
                      ...
                      <div class="table-responsive mt-4">
                        <table class="table table-sm table-bordered">
                          ...
                          <tbody>
                            <tr v-for="(impact, source) in incomeSandbox.impacts" :key="source">
                              <td>{{ impact.label }}</td>
                              <td>${{ impact.amount.toLocaleString() }}</td>
                              <td>{{ impact.taxImpact }}</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <div v-else class="text-center py-5">
                      ...
                      <p class="mt-3 text-muted">Add and adjust income sources to see their impact on Social Security taxation and Medicare premiums.</p>
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  computed: {
    ...
    // Income Layering Sandbox Chart Data
    incomeSandboxChartData() {
      // Only create datasets if calculation has been run
      if (!this.incomeSandbox.calculated) {
        return { labels: [], datasets: [] };
      }
      
      const labels = ['Social Security', 'Traditional IRA', 'Roth IRA', 'Pension', 'Tax-Exempt Interest'];
      const values = [
        this.incomeSandbox.sources.socialSecurity,
        this.incomeSandbox.enabled.traditionalIRA ? this.incomeSandbox.sources.traditionalIRA : 0,
        this.incomeSandbox.enabled.rothIRA ? this.incomeSandbox.sources.rothIRA : 0,
        this.incomeSandbox.enabled.pension ? this.incomeSandbox.sources.pension : 0,
        this.incomeSandbox.enabled.taxExemptInterest ? this.incomeSandbox.sources.taxExemptInterest : 0
      ];
      
      const taxableValues = [
        this.incomeSandbox.taxableSSAmount,
        this.incomeSandbox.enabled.traditionalIRA ? this.incomeSandbox.sources.traditionalIRA : 0,
        0, // Roth IRA is not taxable
        this.incomeSandbox.enabled.pension ? this.incomeSandbox.sources.pension : 0,
        0  // Tax-Exempt Interest is not taxable for income tax (but counts for provisional income)
      ];
        ...
        datasets: [
          {
            ...
            data: values,
            backgroundColor: [
              'rgba(55, 125, 255, 0.7)',  // Social Security
              'rgba(0, 201, 219, 0.7)',   // Traditional IRA
              'rgba(113, 75, 103, 0.7)',  // Roth IRA
              'rgba(255, 193, 7, 0.7)',   // Pension
              'rgba(40, 167, 69, 0.7)'    // Tax-Exempt Interest
            ],
            borderColor: [
              'rgb(55, 125, 255)',
              'rgb(0, 201, 219)',
          ...
          },
          {
            ...
            data: taxableValues,
            backgroundColor: [
              'rgba(255, 107, 107, 0.7)', // Taxable SS
              'rgba(255, 107, 107, 0.7)', // Traditional IRA (fully taxable)
              'rgba(255, 107, 107, 0.7)', // Roth IRA (not taxable)
              'rgba(255, 107, 107, 0.7)', // Pension (fully taxable)
              'rgba(255, 107, 107, 0.7)'  // Tax-Exempt Interest (not taxable for income)
            ],
    ...
    incomeSandboxChartOptions() {
      return {
        ...
        plugins: {
          ...
          title: {
            display: true,
            text: 'Income Sources and Taxation Impact'
          },
          legend: {
            position: 'bottom'
          }
  ...
  methods: {
    ...
    calculateIncomeSandbox() {
      // Implement income layering sandbox calculation
      this.incomeSandbox.calculated = true;
    },
    addCustomStrategy() {

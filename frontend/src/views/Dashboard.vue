  ...
  <div class="row" style="margin-top:20px;">
    <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
      ...
      <a class="card card-hover-shadow h-100" href="#">
        <div class="card-body">
          <h6 class="card-subtitle">Total Medicare Costs (cirlce that has red if over 75% is IRmaa, ornage is over 50% yellow if over 25% and green if below 25%)</h6>

          <div class="row align-items-center gx-2 mb-1">
            <div class="col-6">
              <!-- Pie Chart -->
              <div class="chartjs-custom" style="height: 13rem;">
  ...
  <div class="row">
    <div class="card mb-3 mb-lg-5">
      <div class="card h-100">
        <div class="card-body">
          <!-- Table -->
          <div class="mb-3 d-flex justify-content-between" style="margin-top:20px;">
            <input type="text" v-model="searchQuery" placeholder="Search by name..." class="form-control w-40" />
          </div>
          <div>

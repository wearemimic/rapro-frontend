...
# Django Regular Web Application Auth0 Views
@api_view(['GET'])
...
def auth0_callback(request):
    ...
    try:
        ...
        if token_response.status_code != 200:
            ...
            frontend_url = 'http://localhost:3000/login?error=token_exchange_failed'
            return redirect(frontend_url)
        ...
        if userinfo_response.status_code != 200:
            ...
            frontend_url = 'http://localhost:3000/login?error=userinfo_failed'
            return redirect(frontend_url)
        ...
        # Redirect to frontend with tokens and user data as URL parameters
        frontend_url = (
...
def auth0_login(request):
    ...
    try:
        ...
        domain = settings.AUTH0_DOMAIN
        audience = settings.AUTH0_CLIENT_ID  # Use client_id as audience for SPA
